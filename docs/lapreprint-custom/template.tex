...
% Guard: \DocumentMetadata is only defined in TeX Live 2025+. Without this guard,
% older TeX Live versions emit a blank first page due to the undefined command error.
