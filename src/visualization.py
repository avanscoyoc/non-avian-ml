...
def create_figure():
    input_path = "/workspaces/non-avian-ml-toy/results"
    output_path = "/workspaces/non-avian-ml-toy/tmp/merged_results.csv"
    plot_path = "/workspaces/non-avian-ml-toy/tmp/roc_auc_plot.jpeg"

    df = merge_into_single_dataset(input_path, output_path)
    summary_df = compute_mean_se(df)
    plot_roc_auc_by_train_size(summary_df, plot_path)
